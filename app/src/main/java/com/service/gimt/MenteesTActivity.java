...
public class MenteesTActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mentees_tactivity);
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("teachers").child(phone).child("mentees");
...
//                            .child("semester").child(sem).child("teachers");
                    options= new FirebaseRecyclerOptions.Builder<TeacherlistSData>().setQuery(mDatabase,TeacherlistSData.class).build();
                    ...
                    adapter= new FirebaseRecyclerAdapter<TeacherlistSData, TeacherlistSViewHolder>(options) {
                        ...
                        public TeacherlistSViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                            return new TeacherlistSViewHolder(LayoutInflater.from(MenteesTActivity.this).inflate(R.layout.item_menteeslist_t,viewGroup,false));
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Mentees");
